...
function makeDefaultData() {
  ...
  const settings = {
    ...
    'meta.title': 'Xodija Fashion House — Xivada premium tikuvchi dizayner',
    'meta.description_uz': 'Xiva, Xorazmda 10 yillik tajribali tikuvchi dizayner. Oqshom liboslari, kelin sarposi, ansabil to\'plamlar, kundalik kiyimlar. Individual buyurtma. 910+ baxtli mijoz.',
    'meta.description_ru': 'Дизайнер-портной с 10-летним опытом в Хиве, Хорезм. Вечерние платья, свадебные наряды, ансамбли, повседневная одежда. Индивидуальный пошив. 910+ довольных клиентов.',
    'meta.keywords': 'Xodija Fashion House, tikuvchi Xivada, dizayner libos, kelin sarposi Xorazm, oqshom libos Xiva, ansabil to\'plam, individual tikuvchi, premium libos',
    ...
    'hero.subtitle_uz': 'Tikuvchi dizayner • 10 yillik tajriba • Xiva, Xorazm.\nHar bir libos — sizning betakror nafosatingiz uchun mahorat bilan tikiladi.',
    'hero.subtitle_ru': 'Дизайнер-портной • 10 лет опыта • Хива, Хорезм.\nКаждый наряд шьётся вручную для вашей неповторимой элегантности.',
    ...
    'about.text_uz': 'Men — Xodija. Tikuvchilik — bolaligimdan ko\'nglim bog\'langan ish. 10 yildan ortiq vaqt davomida har bir libosni o\'z qo\'lim bilan, ko\'ngil qo\'yib tikaman. Oqshom liboslari, kelin sarposi yoki kundalik kiyimmi — har bir mijoz uchun individual yondashuv va eng yaxshi matolardan foydalanaman.',
    'about.text_ru': 'Меня зовут Ходжа. Швейное дело — моя страсть с детства. Уже более 10 лет каждое платье я шью своими руками, вкладывая душу. Вечерний наряд, свадебное платье или повседневная одежда — для каждой клиентки индивидуальный подход и лучшие ткани.',
    ...
    'testimonials.subtitle_uz': 'Mijozlarimiz aytgan iliq so\'zlar — eng yaxshi mukofotimiz',
    'testimonials.subtitle_ru': 'Тёплые слова наших клиенток — наша лучшая награда',
    ...
    'order.subtitle_uz': 'Formani to\'ldiring — siz bilan 1 soat ichida bog\'lanamiz',
    'order.subtitle_ru': 'Заполните форму — мы свяжемся с вами в течение часа',

    'footer.tagline_uz': 'Xivadan butun O\'zbekistonga — mahorat va sevgi bilan tikilgan har bir tafsilot.',
    'footer.tagline_ru': 'Из Хивы по всему Узбекистану — каждая деталь сшита с мастерством и любовью.',
